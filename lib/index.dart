...
export '/pages/auth_pages/reporting_form/reporting_form_widget.dart'
    show ReportingFormWidget;
export '/pages/main_pages/main_home_equipo/main_home_equipo_widget.dart'
    show MainHomeEquipoWidget;
