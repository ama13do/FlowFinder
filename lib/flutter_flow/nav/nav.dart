        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'ReportingForm',
              path: 'reportingForm',
              builder: (context, params) => ReportingFormWidget(),
            ),
            FFRoute(
              name: 'Main_Home_Equipo',
              path: 'mainHomeEquipo',
              builder: (context, params) => MainHomeEquipoWidget(),
            ),
            FFRoute(
              name: 'Main_Home_Admin',
              path: 'mainHomeAdmin',
              builder: (context, params) => MainHomeAdminWidget(),
            )
