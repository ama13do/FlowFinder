                      ...
                      child: Stack(
                        ...
                        children: [
                          Align(
                            ...
                            child: Image.network(
                              'https://grupohidraulica.com/wp-content/uploads/2023/07/dectactar-fugas-de-agua-1024x683-1.jpeg',
                              width: double.infinity,
                              height: 240.0,
                              fit: BoxFit.cover,
                            ).animateOnPageLoad(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'yqm004xu' /* Ya van mas de una semana en la... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'st5cr4ca' /* Si, yo ya  rellene mi tinaco d... */,
                                                                ),
