                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'xkz4xjo6' /* Continua explorando cada una d... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelLarge
                                    .override(
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'f4xxyrqv' /* Ingresa tu correo electronico */,
                                        ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          'wt8sx5du' /* Ingresa tu contraseña */,
                                        ),
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                  ...
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        _model.apiResultuv8 =
                                            await InicioDeSesionCall.call(
                                          email: _model
                                              .emailAddressTextController.text,
                                          contrasenia: _model
                                              .passwordTextController.text,
                                        );
                                        if ((_model.apiResultuv8?.succeeded ??
                                            true)) {
