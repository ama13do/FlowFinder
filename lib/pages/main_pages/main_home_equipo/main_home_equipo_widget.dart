...
import 'main_home_equipo_model.dart';
export 'main_home_equipo_model.dart';

class MainHomeEquipoWidget extends StatefulWidget {
  const MainHomeEquipoWidget({super.key});

  @override
  State<MainHomeEquipoWidget> createState() => _MainHomeEquipoWidgetState();
}

class _MainHomeEquipoWidgetState extends State<MainHomeEquipoWidget>
    with TickerProviderStateMixin {
  late MainHomeEquipoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MainHomeEquipoModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Main_Home_Equipo'});
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '8ithmotp' /* Un resumen de tus reportes */,
                                            ),
                                            textAlign: TextAlign.start,
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'hmptpiru' /* Below is an a summary of activ... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'elth8a78' /* Below is an a summary of activ... */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium
                          ...
                          if (responsiveVisibility(
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'MAIN_HOME_EQUIPO_Container_d1wmo2fq_ON_T');
                                                          ...
                                                          Align(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '79uupqbv' /* Calle Progreso #17 Rosario */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .labelMedium
                                                        ...
                                                        Align(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'td1zf9yr' /* Calle Progreso #17 Rosario */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
                                                        ...
                                                        Align(
                                                          ...
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'z37c5mof' /* Calle Progreso #17 Rosario */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .labelMedium
